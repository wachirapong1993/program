...
<div style="border: 2px solid โค้ตสีกรอบ; overflow: auto; width: 100%; height: auto; text-align: center;" >
    <body>
        <table  width="100%" border="1">
            <tr>
                <td   align="center" rowspan="3" ><b>ใบบันทึกการใส่ Part SMT/ RADIAL / AXIAL ( Joid Part )</td>
        ...
        <table  width="100%" border="1">
            ...
            $i = 1;
            $ii= 1;
            foreach ($modelI as $modelI):
//                {
//                echo $modelI->id.'<br>';
//                echo '-----------';
//                echo '<br>';
                $modelD = app\models\JoidPart::find()->where(['start_detail_id' => $modelI->id])->all();

                foreach ($modelD as $data) :
//                    {
//             
//                    echo $value->id.'<br>';
//                }
...
//            foreach ($model as $data):
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 100px;"  ><?= $data->userc->profile->name ?></td>
                        <td align="center" style="width: 100px;"> <?= $data->useru->profile->name ?></td>
