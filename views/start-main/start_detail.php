        ...
        'columns' => [
            ...
            [
                ...
                'detail' => function ($model, $key, $index, $column) {
                    ...
                    return Yii::$app->controller->renderPartial('joid', [
            ...
            [
                ...
                'template' => '<div class="btn-group btn-group-sm text-center" role="group">{start-program/joid}</div>',
                'options' => ['style' => 'width:150px;'],
                'buttons' => [
                    'start-program/joid' => function($url, $model, $key) {
                        if ($model->qc_status_id == 2) {
